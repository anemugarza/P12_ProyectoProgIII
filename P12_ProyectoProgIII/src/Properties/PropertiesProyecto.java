...
public class PropertiesProyecto extends JDialog {
	 ...
	 */
	public PropertiesProyecto( String nomFic, String[] props, String[] mensajes, String[] defecto, String[] tipos ) throws IndexOutOfBoundsException {
		...
		this.nomFic = nomFic;
		setModal(true);
		setTitle( "SERVICIO DE RECLAMACIONES" );
	...
	private class BotonCambiarPath implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			int valor = fc.showDialog( PropertiesProyecto.this, mens );
