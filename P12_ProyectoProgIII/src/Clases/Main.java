...
public class Main {
	public static void main(String[] args) {
		...
		Ropa ropa11 = new Ropa("Camiseta gris mujer", 12.95 , "Camiseta gris de algodón con UD", Talla.M, "Media/CamisetaGrisMujer.JPEG");
		MaterialEscolar material1 = new MaterialEscolar("Libro Electronica", 25.75, "Media/ElectronicaDigital.png" );
		...
		Electronica electronica1 = new Electronica("Teclado", 14.99, "Media/teclado.jpeg", "Teclado 100, Conexión USB, Negro");
		Electronica electronica2 = new Electronica("Auriculares", 16.99, "Media/auriculares.png", "Auriculares apple earpods");
		...
		Electronica electronica7 = new Electronica("Pendrive", 25.99, "Media/pendrive.jpeg", "Memoria Externa USB 256GB Almacenamiento de Datos Extern Flash Drive para PC,Tabletas y Otros Dispositivos.");
